...
if __name__ == '__main__':
    ...
    train_df= hive.query('''select item_id,emb_arr from ks_mmu.item_info_emb where p_date="20220901" and size(emb_arr)!=1 limit 1000000''', smart=False)
    ...
    # for i in train_df.npartitions:
    #     subdf = train_df.get_partition(i).compute()
    #     #do as pandas
    #     break
    # subdf.head()
